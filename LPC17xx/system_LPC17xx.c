...
#define CCLKCFG_Val           0x00000003 //main divider
#define USBCLKCFG_Val         0x00000000
#define PCLKSEL0_Val          0x00000000 | 0<<24// частота АЦП = main/8
#define PCLKSEL1_Val          0x0000000c
...
void SystemInit (void)
{
  ...
  LPC_SC->SCS       = SCS_Val;							/*MINE_COM 6th bit to 1 i.e. 20=>0b100000*/
